...
public class BasicMessage implements Message {
	...
	/**
	 * Returns the message in the format: <code>[sender_id|sender_ip:sender_port|message_id|text|type|receiver_ip:receiver_port|receiver_id]</code>
	 */
	@Override
	public String toString() {
		...
		return "[" + ChordState.chordHash(senderIpAddressPort) + "|" + senderIpAddressPort + "|" +
				getMessageId() + "|" + getMessageText() + "|" + getMessageType() + "|" +
				receiverIpAddressPort + "|" + ChordState.chordHash(receiverIpAddressPort) + "]";
